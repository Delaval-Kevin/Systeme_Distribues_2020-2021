...
public class Stock
{
    ...
    public Stock()
    {
        ...
        this.inventory.put(2, new Item(2, "Console", 100, 4.80f, "other"));
        this.inventory.put(3, new Item(3, "Outils", 60, 21.37f, "other"));
        this.inventory.put(4, new Item(4, "Books", 30, 2.95f, "book"));
    }
